...
## How does it work?
Marrel is built with Sass on top of the grid system from [Bootstrap](http://getbootstrap.com/), [normalize.css](https://necolas.github.io/normalize.css/) and [LINKS](https://github.com/mrmrs/links).
